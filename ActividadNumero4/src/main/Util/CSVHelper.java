...
public class CSVHelper {
    ...
    public static Optional<ContenidoAudioVisual> parseLine(String line) {
        ...
        try {
            ...
            switch (tipo.toLowerCase()) {
                case "pelicula":
                    ...
                    break;
                case "serie":
                    contenido = new SerieTV(titulo, anio, director);
                    break;
                case "documental":
    ...
    public static String toCSV(ContenidoAudioVisual c) {
